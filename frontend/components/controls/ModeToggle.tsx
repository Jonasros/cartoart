    ...
    <div className="w-full px-3 py-3 border-b border-gray-200 dark:border-gray-700">
      <div className="flex rounded-lg bg-gray-100 dark:bg-gray-900 p-1">
        ...
        >
          ...
          <span className="text-[10px] font-medium mt-1 hidden md:block">Print</span>
        </button>
        ...
        >
          ...
          <span className="text-[10px] font-medium mt-1 hidden md:block">Sculpture</span>
        </button>
      </div>
